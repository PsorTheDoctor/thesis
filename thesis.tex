...
\subsection*{\LARGE{1.1. Manipulacja a percepcja}} \addcontentsline{toc}{subsection}{1.1. Manipulacja a percepcja}
...
\subsection*{\LARGE{1.2. Cele manipulacji}} \addcontentsline{toc}{subsection}{1.2. Cele manipulacji}
...
\subsection*{\LARGE{1.3. Afordancje}} \addcontentsline{toc}{subsection}{1.3. Afordancje}
...
\subsection*{\LARGE{1.4. Zarys pracy}} \addcontentsline{toc}{subsection}{1.4. Zarys pracy}
...
\begin{figure}[h]
\centering
\includegraphics[width=13cm]{catch}
...
\subsection*{\LARGE{2.1. Widzenie maszynowe}} \addcontentsline{toc}{subsection}{2.1. Widzenie maszynowe}
...
\subsection*{\LARGE{2.2. Sztuczne sieci neuronowe}} \addcontentsline{toc}{subsection}{2.2. Sztuczne sieci neuronowe}
...
\subsection*{\LARGE{2.3. Uczenie przez wzmacnianie}} \addcontentsline{toc}{subsection}{2.3. Uczenie przez wzmacnianie}
...
\subsection*{\LARGE{3.1. Wyznaczenie najbliższego punktu}} \addcontentsline{toc}{subsection}{3.1. Wyznaczenie najbliższego punktu}
...
\subsection*{\LARGE{3.2. Algorytm najbliższego sąsiada}} \addcontentsline{toc}{subsection}{3.2. Algorytm najbliższego sąsiada}
...
\subsection*{\LARGE{3.3. Transformacje}} \addcontentsline{toc}{subsection}{3.3. Transformacje}
...
\subsection*{\LARGE{3.4. Rozkład macierzy według wartości osobliwych}} \addcontentsline{toc}{subsection}{3.4. Rozkład macierzy według wartości osobliwych}
...
\subsection*{\Large{3.5. Interpretacja geometryczna rozkładu SVD}} \addcontentsline{toc}{subsection}{3.5. Interpretacja geometryczna rozkładu SVD}
...
\newpage
\subsection*{\LARGE{4.1. Implementacja algorytmu}} \addcontentsline{toc}{subsection}{4.1. Implementacja algorytmu}
...
\subsection*{\LARGE{4.2. Działanie robota w praktyce}} \addcontentsline{toc}{subsection}{4.2. Działanie robota w praktyce}
...
\subsection*{\LARGE{5.1. Dalszy rozwój}} \addcontentsline{toc}{subsection}{5.1. Dalszy rozwój}
