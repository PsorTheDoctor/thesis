...
Jedną z najbardziej popularnych technik w uczeniu maszynowych stanowią sieci neuronowe \emph{(ang. ANN - Artificial Neural Network)}. Taką sieć można w uproszczony sposób przedstawić w postaci grafu, którego wierzchołki reprezentują neurony a krawędzie - połączenia między nimi, tzw. synapsy.
